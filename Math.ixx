...
export namespace Math
{
	...
	public:
		...
		Rational& operator++ () { m_nominator += m_denominator; norm(); return *this; }
		Rational operator++ (int x) { Rational star = *this; (*this).m_nominator += m_denominator; norm(); return star; }
		Rational& operator-- () { m_nominator -= m_denominator; norm(); return *this; }
		Rational operator-- (int x) { Rational star = *this; (*this).m_nominator -= m_denominator; norm(); return star; }
